        ...
        <div className='w-screen md:px-4 sticky top-0 bg-[#2D2F33] z-20'>
            <div className="container m-auto flex justify-between items-center md:px-12 p-4 text-white text-sm">
                <h1 className="flex items-center font-[Jeko-Bold] ">
                    <a href='#' className="text-lg font-semibold">Altamash</a>
                    <a href='#' className="text-lg font-[Jeko-Medium] ml-1">Ahmad</a>
                </h1>
                ...
                <div className='md:block hidden'>
                    <ul className="flex gap-4 items-center">
                        ...
                        <a href='mailto:altamshahmadajaz2@gmail.com?subject=Inquiry&body=Hello%2C%0A%0A I have a question about... ' target="_blank" rel="nofollow" className='flex items-center  cursor-pointer rounded-full border border-[#73F8AB] p-1 hover:bg-[#73F8AB] hover:text-white text-[#73F8AB]'><HiOutlineMail /></a>
                    </ul>
                </div>
