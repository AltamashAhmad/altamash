    ...
    <div className="container md:p-12 md:pb-0 px-2 m-auto  flex flex-col-reverse md:flex-row justify-center">
      <div className="w-full md:w-1/2 md:mt-0 mt-16 flex flex-col gap-4 items-start justify-start p-4 relative ">
        <div className="w-full rounded shadow-2xl px-4 py-2">
          ...
          <button className='uppercase mt-3 underline text-white hover:text-[#73F8AB] cursor-pointer'>4 Projects</button>
        </div>
      </div>
      <div className="w-full md:w-1/2 md:minh-[calc(100vh-60px)] p-4 flex flex-col justify-start">
        ...
        <h2 className='md:text-4xl text-3xl font-mono leading-loose text-white mt-6'>Hello! I am Altamash Ahmad</h2>
        ...
        Passionate about web development, I mastered data structures and algorithms, becoming a skilled web developer delivering dynamic solutions to real-world challenges.
        </p>
      </div>
    </div>
  )
